...
| droids    | get       | /api/users/:id/favourites     | Get favourites favourites list             |
| droids    | post      | /api/users/:id/favourites     | Add droid to favourites list               |
| droids    | post      | /api/users/:id/favourites/:did | Remove droid to favourites list               |
