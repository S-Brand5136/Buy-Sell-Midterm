...
- Droids page
  ...
  - [X] Add Object: fit to droid card images

- User / Admin page
  - [X] Page created
    - [ ] Add button to delete a droid
    - [ ] add more distinctive styling for when a droid is sold out
    - [ ] Filter Droids by SOLD_OUT on droids page, so only droids for sale are shown
